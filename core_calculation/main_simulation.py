...
speed_simulation = 1 # expected ratio of real time vs simulation time (e.g. 2 means the simulation will run twice faster than real time)
...
simu = Simulation(json_file="scenarii_examples/simple_spring.json")
